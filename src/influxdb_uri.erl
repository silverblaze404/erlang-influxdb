...
-export([encode/1]).
-export([encode_query/1, encode_component/1, encode_component_plus/1, encode_component/2,
         is_char_reserved/1, is_char_unreserved/1]).
...
-spec encode_component(String, Pred) -> binary()
    when String :: atom() | iodata(),
